...
const allSongs = [
    ...
    {id: 2, title: 'Bad Romance', artist: 'Lady Gaga', tags: ['Solo', 'Pop', 'Party Song'], mp4: 'songs/bad-romance.mp4'},
    {id: 3, title: 'Barbie Girl', artist: 'Aqua', tags: ['Group', 'Solo', 'Pop', 'Party Song'], mp4: 'songs/barbie-girl.mp4'},
    {id: 4, title: 'Bohemian Rhapsody', artist: 'Queen', tags: ['Group', 'Solo', 'Pop', 'Rock', 'Party Song'], mp4: 'songs/bohemian-rhapsody.mp4'},
    {id: 5, title: 'Pretty Good At Drinkin Beer', artist: 'Billy Currington', tags: ['Solo', 'Country', 'Party Song'], mp4: 'songs/drinkin-beer.mp4'},
    {id: 6, title: 'Ice ice baby', artist: 'Vanilla Ice', tags: ['Solo', 'Rap', 'Party Song'], mp4: 'songs/ice-ice-baby.mp4'},
    {id: 7, title: 'Let It Go', artist: 'Frozen', tags: ['Solo', 'Pop', 'Broadway', 'Kids', 'Party Song'], mp4: 'songs/let-it-go.mp4'},
    {id: 8, title: 'Proud Mary', artist: 'Tina Turner', tags: ['Solo', 'Pop', 'R&B/Soul','Uptempo', 'Party Song'], mp4: 'songs/proud-mary.mp4'},
